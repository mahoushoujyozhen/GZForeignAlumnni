<template>
  <div>
    <div class="mobileNav"><span>活动首页</span><a @click="toMyActivity">我的</a></div>
    <MemberNav/>
    <div id="MyActivity"><a @click="toMyActivity">我的活动</a></div>
...
export default {
  name: 'ActivityHome',
  components: {MemberNav, Manage_activity_item },
  data() {
    return {
      activities: [
        {data: 0},
