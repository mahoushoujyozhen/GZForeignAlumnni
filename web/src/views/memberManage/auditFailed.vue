<template>
    ...
    <van-config-provider :theme-vars="themeVars">
      <div v-for="u in datas1" :key="u.id" class="one">
        ...
        <van-cell-group :inset="true">
          <van-field v-model="u.phone" class="filed" label="手机号" readonly />
          <van-field
            v-model="u.sex"
            label="性别"
            class="filed"
  ...
  <van-field v-model="u.idcard" class="filed" readonly >
          ...
          />
          <van-field
            v-model="u.native_place"
            label="籍贯"
            class="filed"
            :readonly="true"
          />
          <van-field
            v-model="u.birth_place"
            label="出生地"
            class="filed"
            :readonly="true"
          />
        ...
        <van-cell-group :inset="true">
          ...
          />
          <van-field
            v-model="u.position_title"
            class="filed"
            label="职称"
            :readonly="true"
          />
          <van-field
            v-model="u.professional"
            class="filed"
            label="从事专业"
            :readonly="true"
          />
          <van-field
            v-model="u.organization"
            class="filed"
            label="机构名称"
            :readonly="true"
          />
          <van-field
            v-model="u.organization_nature"
            label="机构性质"
            class="filed"
            :readonly="true"
          />
          <van-field
            v-model="u.or_telephone"
            class="filed"
            label="机构电话"
            :readonly="true"
          />
          ...
          <van-field label="审核意见" class="filed">
            <template #input>
              <textarea
                  ...
                  textarea
                  readonly
                  class="notThroughTextarea"
              ></textarea>
            </template>
          </van-field>
        </van-cell-group>
        <van-button type="primary" class="notThroughButton" @click="show = true"
          >修改审核结果</van-button
        >
        <van-dialog
          class="dio1"
          ...
          @confirm="confirm1"
        >
          <div class="dio">是否确认更改审核结果为：通过</div>
          <textarea
            v-model="book1"
            textarea
            class="textarea1"
...
export default defineComponent({
  ...
  setup() {
    ...
    const ww = ref('https://img.yzcdn.cn/vant/cat.jpeg');
    ...
    const themeVars = {
      ...
      // cellGroupTitleColor: '#black',
      // cellGroupTitleFontSize: '.6667rem',
      // cellFontSize: '.4533rem',
      fieldWordLimitFontSize: '.4533rem',
      fieldErrorMessageFontSize: '.4533rem',
      fieldClearIconSize: '.8rem',
      fieldLabelWidth: '5em',
      dialogHeaderLineHeight: '2rem',
      dialogWidth: '350px',
    };
